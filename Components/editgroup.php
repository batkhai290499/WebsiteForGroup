        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row ">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header text-uppercase">Edit group</div>
                            <div class="card-body">
                                <form method="post" action="editprocess.php?id=<?php echo $id = $_GET["id"];  ?>">
                                    <thead>
                                        <?php
                                        require_once './database.php';
                                        $sql = "SELECT group1.groupId,group1.groupName ,student.studentName, tutor.tutorName FROM group1 INNER JOIN student ON student.accountId = group1.studentId INNER JOIN tutor ON tutor.accountId = group1.tutorId WHERE student.accountID = '$id'";
                                        //echo $sql;
                                        $rows = query($sql);
                                        ...
                                        ?>
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="tutorGroup" class="form-control single-select">
                                                        <?php
