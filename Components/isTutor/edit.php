        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-header text-uppercase">Add Comment</div>
                            <div class="card-body">
                                <form method="post" action="editprocess.php?id=<?php echo $id = $_GET["id"]; ?>">
                                    <?php
                                    require_once '../database.php';
                                    $sql = "SELECT file.fileId, file.fileName , file.location,account.username, file.comment FROM file INNER JOIN account ON account.accountId = file.student where fileId = " . $id;
                                    $rows = query($sql);
                                    for ($i = 0; $i < count($rows); $i++) {
                                    ?>
                                        <div>
                                            <thead>
                                                <div class="form-group">
                                                    ...
                                                    <div class="card-header text-uppercase"><?= $rows[$i][3] ?></div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="input-6">Comment</label>
                                                    <input type="text" name=cmt class="form-control form-control-rounded" id="input-6" placeholder="<?= $rows[$i][4] ?>">
                                                </div>
                                                <button type="submit" name="addCmt" class="btn btn-light btn-round px-5">Edit</button>
                                                <a href="editprocess.php?id=<?= $rows[$i][0] ?>">ADD</a>
                                            </thead>
